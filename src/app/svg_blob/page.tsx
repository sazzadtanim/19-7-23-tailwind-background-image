...
export default function Home() {
  return (
    <main className='absolute inset-0 h-screen w-screen bg-[hsla(0,100%,50%,1)] bg-radial_gradient bg-cover bg-center pt-10 -z-20'>
      <div className='prose mx-auto px-2 pt-10 text-white'>
        <h1 className='relative mx-auto py-10 text-center font-mono lowercase text-[] first-letter:capitalize lg:whitespace-nowrap'>
          ...
          <Image
            alt=''
            src={blob}
            className='absolute -left-44 -top-20 scale-150 -z-10'
          />
        </h1>
        <div>
